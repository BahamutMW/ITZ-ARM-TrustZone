...
namespace Genode {
	...
	struct Vm_session : Session
	{
			...
			/**
			 * Inject interrupt 'irq' into virtual machine
			 */
			virtual void inject_irq(unsigned irq) = 0;
